...
- CodingProfile stores name, protocol, base_url, model, credential reference, output_mode, token_parameter and max_tokens. ModelSettings stores active and up to 30 uniquely named profiles. Preserve atomic private writes and reject credentials embedded in URLs.
